...
const Footer = () => {
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-60 text-sm text-gray-500'>
            <div className='flex flex-wrap justify-between items-start gap-8 pb-6 border-borderColor border-b md:gap-6'>
                <div>
                ...
                <div>
                    ...
                    <ul className='mt-3 flex flex-col gap-1.5'>
                        ...
                        <li><a href="#">Gandhinagar, Gujarat</a></li>
                        <li><a href="#">+91 98259 21720</a></li>
                        <li><a href="#">snehyadav091@gmail.com</a></li>
                    </ul>
                </div>
